...
def get_default_configs():
  ...
  evaluate.num_samples = 1000    #1000 
  ...
  model.sigma_max = 1#0.6 #0.6#1#50 #378######### ###new(1210)300
  model.sigma_min = 0.01
  model.num_scales = 1000#1000
  model.beta_min = 0.1
  model.beta_max = 20.
  model.dropout = 0.
  ...
  config.seed = 42
  config.device = torch.device('cuda:0') if torch.cuda.is_available() else torch.device('cuda:1')
