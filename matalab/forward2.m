...
% % 
 ...
 %%%%%%%%%%%pic = double(padarray(pic,[150 150]));
...
% if(compInit)
    ...
    % load struct that contains setting information and subSampling mask
     load('/home/pat-303/PAT/github/PAT-Diffusion-main/ggggggfu.mat')
...
%     medium               = [];
  %File "/code/ncsnpp/ncsnpp_holo_train/OAP_view512_sparse_mask/A_1k_arg_PCsampling_
